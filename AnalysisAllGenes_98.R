...
data<-read.csv("/Users/Pinedasans/VDJ/Data/ClonesInferedAll_98.csv")
...
save(clones_mat,diversity_all,data,file="~/VDJ/Data/Data_all_98.Rdata")

load("~/VDJ/Data/Data_all_98.Rdata")
...
save(clone_type_gDNA_df,clone_type_gDNA_num_reduced,diversity_long_gDNA_filter,file="~/VDJ/Data/clonesInferedAll_gDNA_98.Rdata")
...
save(clone_type_cDNA_df,clone_type_cDNA_num_reduced,diversity_long_cDNA_filter,file="~/VDJ/Data/clonesInferedAll_cDNA_98.Rdata")
...
#####
load("~/VDJ/Data/clonesInferedAll_cDNA_98.Rdata")
load("~/VDJ/Data/clonesInferedAll_gDNA_98.Rdata")
...
write.csv(common,"common_98.csv",row.names = F)
common<-read.csv("common_98.csv")
