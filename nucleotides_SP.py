...
def ProcessGroup(nucleotides_Dataframe, unique_VJCDR3_Series, i):
    ...
    nucleotides_Array = list(selected_VJCDR3_Dataframe['cdr3_seq'])
    ##Obtain the number of clones inferred
    Clones_Infered_indexed = ProcessNucleotides(nucleotides_Array)
    selected_VJCDR3_Dataframe_sorted = selected_VJCDR3_Dataframe.sort_values(['cdr3_seq'])
...
def main():
    ...
    ########################
    print("Start")
    nucleotides_Dataframe = pd.read_csv("/Users/Pinedasans/ImmuneRep_Pregnancy/Data/BCR/data_clonesInference_down1.txt",sep="\t")
    ...
    ###Result
    result_ClonesInfered.to_csv('/Users/Pinedasans/ImmuneRep_Pregnancy/Data/BCR/ClonesInfered_down1.csv')
    print("End")
