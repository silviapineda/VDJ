...
setwd("/Users/Pinedasans/Documents/VDJ/DownSamplingAmp/")
load("/Users/Pinedasans/Data/VDJ/VDJ_amplification_downSampled.Rdata")
load("/Users/Pinedasans/Data/VDJ/VDJ_downsampled_amp_igh.Rdata")
...
##gDNA
reads_clones_annot_Long_gDNA <- reads_clones_annot_Long[which(reads_clones_annot_Long$read_count_gDNA>100),] ## 67 samples (Discard samples with less than 100 reads)
clinLong_gDNA <- clinLong[which(reads_clones_annot_Long$read_count_gDNA>100)] #(Discard samples with less than 100 reads)

##cDNA
reads_clones_annot_Long_cDNA <- reads_clones_annot_Long[which(reads_clones_annot_Long$read_count_cDNA>100),] ## 67 samples (Discard samples with less than 100 reads)
clinLong_cDNA <- clinLong[which(reads_clones_annot_Long$read_count_cDNA>100)] #(Discard samples with less than 100 reads)
...
#######################################################################################
### Study with Downsampling by ampl using 100 samples without re-doing the clones ####
#####################################################################################
...
#gDNA
p2.gDNA<-ggplot(data=reads_clones_annot_Long_gDNA, aes(x=time, y=clones_igh_gDNA_downsample_Long, group=subject_id, shape=clinLong_gDNA, color=clinLong_gDNA)) +
  geom_line() +
  geom_point() +
  #ylim(0,120000) +
  scale_colour_manual(values=c("chartreuse4", "dodgerblue3","darkorange2")) +
...
#cDNA
p2.cDNA<-ggplot(data=reads_clones_annot_Long_cDNA, aes(x=time, y=clones_igh_cDNA_downsample, group=subject_id, shape=clinLong_cDNA, color=clinLong_cDNA)) +
  geom_line() +
  geom_point() +
  #ylim(0,120000) +
  scale_colour_manual(values=c("chartreuse4", "dodgerblue3","darkorange2")) +
...
#gDNA
par(mfrow = c(2, 2))  
boxplot(reads_clones_annot_Long_gDNA$clones_igh_gDNA_downsample_Long[which(reads_clones_annot_Long_gDNA$time==0)] ~ clinLong_gDNA[which(reads_clones_annot_Long_gDNA$time==0)], 
        main="Time 0 gDNA", ylab = "Number of clones", col = c("chartreuse4", "dodgerblue3","darkorange2"),ylim=c(0,1000))
fit = lm((reads_clones_annot_Long_gDNA$clones_igh_gDNA_downsample_Long[which(reads_clones_annot_Long_gDNA$time==0)]) ~ clinLong_gDNA[which(reads_clones_annot_Long_gDNA$time==0)])
anova(fit)

boxplot((reads_clones_annot_Long_gDNA$clones_igh_gDNA_downsample_Long[which(reads_clones_annot_Long_gDNA$time==6)]) ~ clinLong_gDNA[which(reads_clones_annot_Long_gDNA$time==6)], 
        main="Time 6 gDNA",ylab = "Number of clones", col = c("chartreuse4", "dodgerblue3","darkorange2"),ylim=c(0,1000))
fit = lm((reads_clones_annot_Long_gDNA$clones_igh_gDNA_downsample_Long[which(reads_clones_annot_Long_gDNA$time==6)]) ~ clinLong_gDNA[which(reads_clones_annot_Long_gDNA$time==6)])
anova(fit)

boxplot((reads_clones_annot_Long_gDNA$clones_igh_gDNA_downsample_Long[which(reads_clones_annot_Long_gDNA$time==24)]) ~ clinLong_gDNA[which(reads_clones_annot_Long_gDNA$time==24)], ylab = "Number of clones", 
        main="Time 24 gDNA",col = c("chartreuse4", "dodgerblue3","darkorange2"),ylim=c(0,1000))
fit = lm((reads_clones_annot_Long_gDNA$clones_igh_gDNA_downsample_Long[which(reads_clones_annot_Long_gDNA$time==24)]) ~ clinLong_gDNA[which(reads_clones_annot_Long_gDNA$time==24)])
anova(fit)

#cDNA
par(mfrow = c(1, 2))  
boxplot(reads_clones_annot_Long_cDNA$clones_igh_cDNA_downsample[which(reads_clones_annot_Long_cDNA$time==6)] ~ clinLong_cDNA[which(reads_clones_annot_Long_cDNA$time==6)], 
        main="Time 6 cDNA", ylab = "Number of clones", col = c("chartreuse4", "dodgerblue3","darkorange2"),ylim=c(0,50000))
fit = lm((reads_clones_annot_Long_cDNA$clones_igh_cDNA_downsample[which(reads_clones_annot_Long_cDNA$time==6)]) ~ clinLong_cDNA[which(reads_clones_annot_Long_cDNA$time==6)])
anova(fit)

boxplot((reads_clones_annot_Long_cDNA$clones_igh_cDNA_downsample[which(reads_clones_annot_Long_cDNA$time==24)]) ~ clinLong_cDNA[which(reads_clones_annot_Long_cDNA$time==24)], ylab = "Number of clones", 
        main="Time 24 cDNA",col = c("chartreuse4", "dodgerblue3","darkorange2"),ylim=c(0,50000))
fit = lm((reads_clones_annot_Long_cDNA$clones_igh_cDNA_downsample[which(reads_clones_annot_Long_cDNA$time==24)]) ~ clinLong_cDNA[which(reads_clones_annot_Long_cDNA$time==24)])
anova(fit)
...
#gDNA
p2.gDNA<-ggplot(data=reads_clones_annot_AR_gDNA, aes(x=time, y=clones_igh_gDNA_downsample_Long, group=subject_id, shape=clinAR_gDNA, color=clinAR_gDNA)) +
  geom_line() +
  geom_point() +
  #ylim(0,120000) +
  scale_colour_manual(values=c("goldenrod","firebrick3")) +
...
#cDNA
p2.cDNA<-ggplot(data=reads_clones_annot_AR_cDNA, aes(x=time, y=clones_igh_cDNA_downsample, group=subject_id, shape=clinAR_cDNA, color=clinAR_cDNA)) +
  geom_line() +
  geom_point() +
  #ylim(0,120000) +
  scale_colour_manual(values=c("goldenrod","firebrick3")) +
...
boxplot(reads_clones_annot_NP_AR_gDNA$clones_igh_gDNA_downsample_Long ~ clin_NP_AR_gDNA, main = "NP_AR gDNA" , ylab = "Number of clones",col = c("chartreuse4","goldenrod","firebrick3"))
fit = lm((reads_clones_annot_NP_AR_gDNA$clones_igh_gDNA_downsample_Long~ clin_NP_AR_gDNA))
anova(fit)
...
boxplot(reads_clones_annot_NP_AR_cDNA$clones_igh_cDNA_downsample ~ clin_NP_AR_cDNA, main = "NP_AR cDNA" , ylab = "Number of clones",col = c("chartreuse4","goldenrod","firebrick3"))
fit = lm((reads_clones_annot_NP_AR_cDNA$clones_igh_cDNA_downsample ~ clin_NP_AR_cDNA))
anova(fit)
