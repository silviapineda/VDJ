...
setwd("/Users/Pinedasans/Documents/VDJ/DownSampledIndividualsMinimum//")
load("/Users/Pinedasans/Data/VDJ/VDJ_downSampled_ind.Rdata")
...
## 1.1plot reads
reads_clones_annot_Long<-reads_clones_down_annot_ind[which(reads_clones_down_annot_ind$clin!="AR" & reads_clones_down_annot_ind$clin!="pre-AR"),]
...
p2.gDNA<-ggplot(data=reads_clones_annot_Long_gDNA, aes(x=time, y=clones_down_gDNA, group=subject_id, shape=clinLong_gDNA, color=clinLong_gDNA)) +
  ...
  ggtitle("Down by Individual - Clones Long gDNA")
...
p2.cDNA<-ggplot(data=reads_clones_annot_Long_cDNA, aes(x=time, y=clones_down_cDNA, group=subject_id, shape=clinLong_cDNA, color=clinLong_cDNA)) +
  ...
  #ylim(0,120000) +
  scale_colour_manual(values=c("chartreuse4", "dodgerblue3","darkorange2")) +
  ggtitle("Down by Individual - Clones Long cDNA")
...
boxplot(reads_clones_annot_Long_gDNA$clones_down_gDNA[which(reads_clones_annot_Long_gDNA$time==0)] ~ clinLong_gDNA[which(reads_clones_annot_Long_gDNA$time==0)], 
        main="Time 0 gDNA", ylab = "Number of clones", col = c("chartreuse4", "dodgerblue3","darkorange2"),ylim=c(0,7000))
...
boxplot((reads_clones_annot_Long_gDNA$clones_down_gDNA[which(reads_clones_annot_Long_gDNA$time==6)]) ~ clinLong_gDNA[which(reads_clones_annot_Long_gDNA$time==6)], 
        main="Time 6 gDNA",ylab = "Number of clones", col = c("chartreuse4", "dodgerblue3","darkorange2"),ylim=c(0,7000))
...
boxplot((reads_clones_annot_Long_gDNA$clones_down_gDNA[which(reads_clones_annot_Long_gDNA$time==24)]) ~ clinLong_gDNA[which(reads_clones_annot_Long_gDNA$time==24)], ylab = "Number of clones", 
        main="Time 24 gDNA",col = c("chartreuse4", "dodgerblue3","darkorange2"),ylim=c(0,7000))
...
## 2.1 plot reads
reads_clones_annot_AR<-reads_clones_down_annot_ind[which(reads_clones_down_annot_ind$clin=="AR" | reads_clones_down_annot_ind$clin=="pre-AR"),]
...
p2.gDNA<-ggplot(data=reads_clones_annot_AR_gDNA, aes(x=time, y=clones_down_gDNA, group=subject_id, shape=clinAR_gDNA, color=clinAR_gDNA)) +
  ...
  ggtitle("Down by Individual - Clones AR gDNA")
...
p2.cDNA<-ggplot(data=reads_clones_annot_AR_cDNA, aes(x=time, y=clones_down_cDNA, group=subject_id, shape=clinAR_cDNA, color=clinAR_cDNA)) +
  ...
  #ylim(0,120000) +
  scale_colour_manual(values=c("goldenrod","firebrick3")) +
  ggtitle("Down by Individual - Clones AR cDNA")

ggplot2.multiplot(p2.gDNA,p2.cDNA)

## 2.3 boxplot with NP as baseline- ANOVA
reads_clones_annot_NP_AR<-reads_clones_down_annot_ind[which(reads_clones_down_annot_ind$clin=="NP" | reads_clones_down_annot_ind$clin=="AR" | reads_clones_down_annot_ind$clin=="pre-AR"),]
clin_NP_AR<-factor(reads_clones_annot_NP_AR$clin, levels=c("NP", "pre-AR","AR"))

par(mfrow = c(1, 2))  
#gDNA
reads_clones_annot_NP_AR_gDNA<- reads_clones_annot_NP_AR[which(reads_clones_annot_NP_AR$read_count_gDNA>100),] ## 20 samples (Discard samples with less than 100 reads)
clin_NP_AR_gDNA <- clin_NP_AR[which(reads_clones_annot_NP_AR$read_count_gDNA>100)] 
...
#cDNA
reads_clones_annot_NP_AR_cDNA<- reads_clones_annot_NP_AR[which(reads_clones_annot_NP_AR$read_count_cDNA>100),] ## 20 samples (Discard samples with less than 100 reads)
clin_NP_AR_cDNA <- clin_NP_AR[which(reads_clones_annot_NP_AR$read_count_cDNA>100)] 
